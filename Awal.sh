...
clear
   ...
   echo -e "\033[31m$(figlet -f Remo773 "Spam Wa")\e[0m"

   echo

   echo -e $kuning" ╔═══════════════════════════════════════════════╗"

   echo -e $kuning" ║"   "\033[1;36mPEMBUAT    : Awal Nurdianto                      "$kuning"    ║"

   echo -e $kuning" ║"   "\033[1;36mINSTAGRAM      : awalnurdianto10                   "$kuning"    ║"

   echo -e $kuning" ║"   "\033[1;36mFACEBOOK : 始まり                      "$kuning"    ║"

   echo -e $kuning" ║"   "\033[1;36mTikTok    : https://vt.tiktok.com/ZSdbcfojG/  "$kuning"    ║"

   echo -e $kuning" ╚═══════════════════════════════════════════════╝"

   echo -e $putih "╔════════════════════════╗"

   echo -e " ║ " "\033[1;31m  SCRIP SPAM WHATSAPP" $putih "  ║"
